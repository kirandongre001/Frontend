  ...
  const addRide = (e) => {
    ...
    const reqOptions = {
      ...
      body: JSON.stringify({
        ...
        start_location: ride.s_city,
        end_location: ride.e_city,
        date_of_journey: ride.doj,
        vehicle_id: ride.vehicle,
        time_of_departure: ride.d_time,
        time_of_arival: ride.r_time,
  ...
  return (
    <div className="rideForm">
      ...
      <div
        className="message"
        style={{
          display: vehicles.length ? "none" : "block",
          marginTop: "300px",
        }}
      >
        <h4 style={{ margin: "20px" }}>
          Please Enter Vehicle Information First
        </h4>
        <Button
          type="button"
          ...
          <form className="rideForms">
            ...
            >
              <Select
                ...
                className=""
                onChange={(e) => {
                  dispatchr({ type: "update", fld: "s_city", value: e });
                }}
              >
                {cities.map((v) => {
                  return (
            ...
            >
              <Select
                ...
                className=""
                onChange={(e) => {
                  dispatchr({ type: "update", fld: "e_city", value: e });
                }}
              >
                {cities.map((v) => {
                  return (
              ...
              <Input
                ...
                onChange={(e) => {
                  ...
                  if (date1 <= date2) {
                    setDisabled(false);
                    rides.map((r) => {
                      if (r.date_of_journey === date2) setDisabled(true);
                    });
                    dispatchr({
                      type: "update",
                      fld: "doj",
            ...
            >
              <Select
                ...
                className=""
                onChange={(e) => {
                  dispatchr({ type: "update", fld: "vehicle", value: e });
                }}
              >
                {vehicles.map((v) => {
                  return (
                    <Select.Option key={v} value={v.id}>
                      {v.carmodels.model_name}
                    </Select.Option>
                  );
                })}
              </Select>
            ...
            >
              <Select
                ...
                className=""
                onChange={(e) => {
                  dispatchr({ type: "update", fld: "seats", value: e });
                }}
              >
